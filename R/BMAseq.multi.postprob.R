...
##' @param interaction Variables considered in interaction terms, a vector, default is NULL.
...
BMAseq.multi.postprob <- function(dat.expr.counts, dat.pheno, var.pool, max.nvar, interaction = NULL, cut.BF = 1) {
